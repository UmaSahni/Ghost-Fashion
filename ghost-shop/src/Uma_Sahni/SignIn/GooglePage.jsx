...
const GooglePage = () => {
  return (
    <Flex bg={"#e6e7e8"} height={"100vh"} alignItems={"center"} >
      <Box backgroundColor={"white"} border={"1px solid #cacaca"} margin={"auto"} width={"30rem"}>
       <Text m="4" color={"#3f3c3c"} fontWeight={"bold"} fontSize="sm" >Login with The Ghost Fashion</Text> 
