    ...
    >
         <div className='crousel' >
            ...
            <div className='collectionmens' style={{marginTop:"30px"}}>
             <Box>
                 <Text fontWeight={"bold"} color="gray" fontFamily={"heading"} fontSize="2xl">COLLECTIONS</Text>
            ...
            className='categorymens' style={{marginTop:"30px"}}>
             <Box>
                 <Text fontWeight={"bold"} color="gray" fontFamily={"heading"} fontSize="2xl">CATEGORIES</Text>
         ...
         <Text fontWeight={"bold"} color="gray" fontFamily={"heading"} fontSize="2xl">OFFICIAL MERCHANDISE</Text>
             ...
             <Grid  gridTemplateColumns={{base:"repeat(2,1fr)", md:"repeat(3,1fr)" , lg:"repeat(5,1fr)"}} gap={30} width="92%" margin="auto" marginTop={5}>
               ...
               <Text fontWeight={"bold"} color="gray" fontFamily={"heading"} fontSize="2xl">TOP SELLING</Text>
